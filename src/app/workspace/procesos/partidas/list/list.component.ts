...
export class ListComponent implements OnInit {
  loading: boolean;
	...
	columns: string[] = ['partidaID', 'fechaDocumento', 'fechaRegistro', 'referencia', 'moneda', 'empresa', 'texto', 'total'];
	...
	edit(element: any) {
		this.router.navigate(['/content/procesos/partidas/edit', element._id]);
	}
